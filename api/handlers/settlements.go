...
func (h *SettlementHandler) Create(c *gin.Context) {
	...
	participants := []activityParticipant{
		...
		{UserID: req.PaidTo, Role: "recipient"},
	}
	if err := h.recordGroupActivity(tx, groupID, userID, summary, participants); err != nil {
...
func (h *SettlementHandler) recordGroupActivity(tx *sqlx.Tx, groupID, userID int, summary string, participants []activityParticipant) error {
	var activityID int
